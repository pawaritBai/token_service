...
public class serviceCus {
	...
	private static final String JWT_TOKEN_KEY = "A2971B74B8B757D52BC8847FCC1D4" ; /*System.getenv("JWT_SECRET_KEY");*/
	...
	private Customer validUser(Customer c) {
	    ...
	    Customer customer = cusDao.findCustomer(c);
	    if(customer == null){
